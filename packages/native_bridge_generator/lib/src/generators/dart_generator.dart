...
class DartGenerator extends GeneratorBase {
  ...
  String generateDartCode(UnifiedTypeSchema schema) {
    ...
    buffer.writeln();
    buffer.writeln("import 'package:native_bridge/native_bridge.dart';");
    buffer.writeln();
    ...
    // Generate main binding class (for top-level functions)
  ...
  void _generateBindingClass(
    ...
    buffer.writeln(
        "  static const _channel = NativeBridgeChannel('$channelName');");
    buffer.writeln();

    for (final method in schema.functions) {
      _generateMethod(buffer, method, indent: '  ');
      buffer.writeln();
    }
  ...
  void _generateClass(
    ...
    if (classDef.kind == UtsClassKind.abstractClass) {
      buffer.writeln('abstract class ${classDef.name} {');
