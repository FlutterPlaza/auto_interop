...
void main() {
  group('NativeBridgeException', () {
    test('creates with code only', () {
      const exception = NativeBridgeException(code: 'ERROR');
    ...
    test('creates from PlatformException', () {
      ...
      final exception =
          NativeBridgeException.fromPlatformException(platformEx);
  ...
  group('ErrorHandler', () {
    ...
    test('converts PlatformException to NativeBridgeException', () async {
      expect(
